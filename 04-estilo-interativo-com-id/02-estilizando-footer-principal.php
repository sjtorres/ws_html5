        ...
        <footer class="container bg-light">
            <section class="main_footer content">
                ...
                <nav class="box box-medium">
                    <h1 class="title font-bold">Mais Sobre WS HTML5</h1>
                    <ul>
                ...
                <article class="main_ead box box-medium last">
                    ...
                    <p class="shoticon shoticon-config"><b>Plataforma EAD:</b> <a title="Plataforma Sandro Torres" href="http://sandrotorres.com.br"> sandrotorres.com.br</a></p>
